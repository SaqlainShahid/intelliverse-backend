...
const { getEvents, getEvent, createEvent, updateEvent, deleteEvent, joinEvent, leaveEvent, getEventCategories, generateEventQr, checkInEvent, submitEventFeedback, getEventFeedback, sendUpcomingReminders, resolveEventByCode, getEventIcs, downloadAttendeesCsv, announceEvent } = require('../controllers/eventController');
...
// Protected
router.post('/', authenticate, authorize('faculty','admin'), (req, res, next) => {
